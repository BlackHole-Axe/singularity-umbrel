...
export class Registry extends EventEmitter {
  constructor(cfg) {
    ...
    try {
      ...
      if (fs.existsSync(this.foundPath)) {
        // tolerate a single torn line (crash mid-append) instead of losing ALL history
  ...
  recordBlock(info) {
    ...
    catch (e) { this.emit('log', `WARNING: could not persist found block to ${this.foundPath}: ${e.message} (block WAS submitted to bitcoind)`); }
